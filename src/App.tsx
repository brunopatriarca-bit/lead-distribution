...
import { LayoutDashboard, Users, RefreshCw, Map, Upload, Globe } from 'lucide-react';
        ...
        <aside className="w-56 bg-white border-r border-gray-200 flex flex-col flex-shrink-0">
          ...
          <nav className="flex-1 p-3 space-y-0.5">
            ...
            <div className="pt-3 pb-1">
              <p className="text-[10px] font-medium text-gray-400 px-3 uppercase tracking-wider">Configuração</p>
            </div>
            <NavItem to="/regioes" icon={<Map size={15} />}             label="Regiões" />
            <NavItem to="/sync"    icon={<RefreshCw size={15} />}       label="Sincronizar" />
          </nav>
          <div className="p-4 border-t border-gray-200">
            <p className="text-xs text-gray-400">v1.1 · Neon DB</p>
          </div>
        </aside>
